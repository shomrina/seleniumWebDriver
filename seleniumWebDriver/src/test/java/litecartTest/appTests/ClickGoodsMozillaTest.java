...
/**
 * Created by Marisha on 06.03.2017.
 */
public class ClickGoodsMozillaTest {
    ...
    public void openMainPageInFirefox() {
    ...
    @Test
    public void clickGoodsTestInFirefox() {
        ...
        Assert.assertEquals(regularPriceColor1, "rgb(119, 119, 119)");
        Assert.assertEquals(salePriceColor1, "rgb(204, 0, 0)");
        ...
        Assert.assertEquals(regularPriceStyle1, "400");
        Assert.assertEquals(salePriceStyle1, "900");
        ...
        Assert.assertEquals(regularPriceColor2, "rgb(102, 102, 102)");
        Assert.assertEquals(salePriceColor2, "rgb(204, 0, 0)");
        ...
        Assert.assertEquals(regularPriceStyle2, "400");
        Assert.assertEquals(salePriceStyle2, "700");
